...
void StackSigBckg(TString variable,TString method,Float_t ct)
{
    gROOT->Reset();
    //gROOT->Reset();
   ...
   ////
    TString Fsct=" ";
    TString sct=Form("%f",ct); //float to stirng ct
    TString Fsct=sct(0,4);

    THStack *hs1=new THStack("hs1","Signal & Background for "+variable+", "+method+">"+Fsct+"                         14TeV,   300 fb^{-1}  ");

    
        
    TH1F* Element_DiBoson;
    TFile *bkg1 = TFile::Open(variable+"_"+method+"_"+Fsct+"ForSignal.root");
    Element_DiBoson= (TH1F*) bkg1->Get("htemp");
    Element_DiBoson->SetFillColor(kGreen);
      

	
    TH1F* Element_BosonJets;
    TFile *bkg2 = TFile::Open(variable+"_"+method+"_"+Fsct+"ForBckg.root");
    Element_BosonJets= (TH1F*) bkg2->Get("htemp");
...
*/
  ...
  TCanvas* c1 = new TCanvas("c1","stack__bckgrnd",800,40,1000,800) ;
    c1->cd(1);
...
//		pl->AddEntry(ML5, "ML5","lpf" );
    ...
    c1->SaveAs("/home/cakir/Desktop/"+variable+"_"+method+"_"+Fsct+".pdf");
    c1->SaveAs("/home/cakir/Desktop/"+variable+"_"+method+"_"+Fsct+".root");
/*
